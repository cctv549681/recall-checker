...
class JinlingguanScraper(BaseScraper):
    """金领冠召回数据爬虫"""

    def __init__(self):
        super().__init__("金领冠", "Jinlingguan")
    ...
    def scrape_samr_cn(self) -> List[Dict[str, Any]]:
        ...
        # SAMR 搜索金领冠相关的召回
        url = "https://www.samr.gov.cn/zh/search/search.html?searchValue=金领冠&category=1005"
    ...
    def scrape_yili_official(self) -> List[Dict[str, Any]]:
        """
        从伊利官网（金领冠）抓取召回信息
        ...
        # 伊利官网召回公告页面
        url = "https://www.yili.com/news/recall?brand=jinlingguan"
        ...
        for item in news_items:
            ...
            if detail_url and not detail_url.startswith('http'):
                detail_url = f"https://www.yili.com{detail_url}"
        ...
        print(f"✅ 伊利官网: 共 {len(products)} 条记录")
        return products
    ...
    def scrape(self) -> List[Dict[str, Any]]:
        ...
        # 抓取伊利官网
        official_products = self.scrape_yili_official()
