...
class FeiheScraper(BaseScraper):
    """飞鹤召回数据爬虫"""

    def __init__(self):
        super().__init__("飞鹤", "Feihe")
    ...
    def scrape_samr_cn(self) -> List[Dict[str, Any]]:
        ...
        # SAMR 搜索飞鹤相关的召回
        url = "https://www.samr.gov.cn/zh/search/search.html?searchValue=飞鹤&category=1005"
    ...
    def scrape_official(self) -> List[Dict[str, Any]]:
        ...
        # 飞鹤官网召回公告页面
        url = "https://www.feihe.com/news/recall"
        ...
        for item in news_items:
            ...
            if detail_url and not detail_url.startswith('http'):
                detail_url = f"https://www.feihe.com{detail_url}"
        ...
        print(f"✅ 飞鹤官网: 共 {len(products)} 条记录")
        return products
...
def main():
    ...
    # 格式化数据
    source_url = "https://www.feihe.com"
