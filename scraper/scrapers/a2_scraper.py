...
class A2Scraper(BaseScraper):
    """a2至初召回数据爬虫"""

    def __init__(self):
        super().__init__("a2至初", "a2")
    ...
    def scrape_samr_cn(self) -> List[Dict[str, Any]]:
        ...
        # SAMR 搜索 a2 相关的召回
        url = "https://www.samr.gov.cn/zh/search/search.html?searchValue=a2&category=1005"
    ...
    def scrape_official(self) -> List[Dict[str, Any]]:
        ...
        # a2 至初官网召回公告页面
        url = "https://www.a2nutrition.com.cn/news/recall"
        ...
        for item in news_items:
            ...
            if detail_url and not detail_url.startswith('http'):
                detail_url = f"https://www.a2nutrition.com.cn{detail_url}"
        ...
        print(f"✅ a2 至初官网: 共 {len(products)} 条记录")
        return products
    ...
    def scrape_mpi_nz(self) -> List[Dict[str, Any]]:
        """
        从新西兰 MPI 抓取召回信息
        ...
        # MPI 搜索 a2 相关的召回
        url = "https://www.mpi.govt.nz/food-safety/food-recalls/search?q=a2"
        ...
        for item in recall_items:
            ...
            # 提取产品信息
            product_data = self._extract_mpi_product_data(item, title)
            products.append(product_data)

        print(f"✅ MPI NZ: 共 {len(products)} 条记录")
        return products

    def _extract_mpi_product_data(self, item, title: str) -> Dict[str, Any]:
        """从 MPI 召回项中提取产品数据"""
        data = {
            'product_name': title,
            'pack_size': '',
    ...
    def scrape(self) -> List[Dict[str, Any]]:
        ...
        # 抓取新西兰 MPI
        mpi_products = self.scrape_mpi_nz()
        all_products.extend(mpi_products)
...
def main():
    ...
    # 格式化数据
    source_url = "https://www.a2nutrition.com.cn"
